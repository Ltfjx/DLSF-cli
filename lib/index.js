...
function startWorker() {
    workerList.forEach((target, workerIndex) => {
        ...
        setTimeout(() => {
            let firstTry = true;
            let worker = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                if (cooldownProgress >= 1) {
                    ...
                    if (!cliParams.noCheck) {
                        ...
                        yield (0, api_1.api)("/selectcourse/initACC", { courseCode: target.courseCode })
                            .then((result) => {
                            ...
                            exports.logger.errorRaw("Error checking course availability: ", error);
                        });
                    }
                    if (cliParams.noCheck) {
                    ...
                    if (firstTry || !isFull) {
                        (0, api_1.api)("/selectcourse/scSubmit", { cttId: target.targetId }).then((result) => {
                            if (result.msg == "F") {
            ...
            exports.logger.debugRaw("Workers: ", workers);
        }, workerIndex * 100);
    });
