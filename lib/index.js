...
function init() {
    ...
    api_1.cookie.JSESSIONID = cliParams.jsessionid;
    api_1.cookie.array = cliParams.newjwgl;
    ...
    const promises = cliParams.targets.map((target) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield (0, api_1.api)("/selectcourse/initACC", { courseCode: courseCode, _: cttId });
